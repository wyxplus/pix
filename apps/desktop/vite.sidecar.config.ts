...
function isExternal(id: string): boolean {
  if (id === "undici" || id === "proper-lockfile") return true;
...
export default defineConfig({
  ...
  build: {
    ...
    lib: {
      entry: {
        sidecar: resolve(import.meta.dirname, "src/sidecar/bootstrap.ts"),
        "memory-worker": resolve(import.meta.dirname, "src/sidecar/memory-worker.ts"),
      },
      formats: ["es"],
